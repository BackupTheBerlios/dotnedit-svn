...
static struct prefData {
    ...
    char prevOpenFilesMask[MAXPATHLEN];   	/* regex to omit from Open Previous menu */
...
static PrefDescripRec PrefDescrip[] = {
	...
	NULL, True},
    {"fileCommands", "FileCommands", PREF_ALLOC_STRING,
	"Open...:Ctrl+O:O::: {\n\
		open_dialog()\n\
	}\n\
	...
	Exit:Ctrl+Q:x:S:: {\n\
		exit()\n\
	}", &TempStringPrefs.fileCmds, NULL, True},
    {"editCommands", "EditCommands", PREF_ALLOC_STRING,
	"Cut:Ctrl+X:t:R:: {\n\
		cut_clipboard()\n\
	}\n\
	Copy:Ctrl+C:C:R:: {\n\
	...
	Paste[Column]:Ctrl+V:P::[Shift]: {\n\
		paste_clipboard()\n\
	}\n\
	PasteColumn:Shift+Ctrl+V::H:: {\n\
	...
	Insert Form Feed:Alt+Ctrl+L:I:S:: {\n\
		insert_string(\"\\f\")\n\
	}\n\
	Insert Ctrl Code...:Alt+Ctrl+I:n::: {\n\
		control_code_dialog()\n\
	}", &TempStringPrefs.editCmds, NULL, True},
    {"searchCommands", "SearchCommands", PREF_ALLOC_STRING,
	"Find...:Ctrl+F:F::[Shift]: {\n\
		find_dialog()\n\
	}\n\
	...
	Find Definition:Ctrl+D:D::: {\n\
		find_definition()\n\
	}\n\
	Show Calltip::C::: {\n\
		show_tip()\n\
	}", &TempStringPrefs.searchCmds, NULL, True},
#ifdef VMS
...
/*  TODO: Some tests indicate that these have to be upper case, but what about
    ...
    {"prevOpenFilesMask", "PrevOpenFilesMask", PREF_STRING, "", PrefData.prevOpenFilesMask,
      (void *)sizeof(PrefData.prevOpenFilesMask), False},    
...
#endif /* VMS */
    if (TempStringPrefs.fileCmds != NULL) {
	LoadFileCmdsString(TempStringPrefs.fileCmds);
	XtFree(TempStringPrefs.fileCmds);
	TempStringPrefs.fileCmds = NULL;
    }
    if (TempStringPrefs.editCmds != NULL) {
	LoadEditCmdsString(TempStringPrefs.editCmds);
	XtFree(TempStringPrefs.editCmds);
	TempStringPrefs.editCmds = NULL;
    }
    if (TempStringPrefs.searchCmds != NULL) {
	LoadSearchCmdsString(TempStringPrefs.searchCmds);
	XtFree(TempStringPrefs.searchCmds);
	TempStringPrefs.searchCmds = NULL;
    }
...
void SaveNEditPrefs(Widget parent, int quietly)
{
    ...
    TempStringPrefs.fileCmds = WriteFileCmdsString();
    TempStringPrefs.editCmds = WriteEditCmdsString();
    TempStringPrefs.searchCmds = WriteSearchCmdsString();
...
char *GetPrevOpenFilesMask(void)
{
    return PrefData.prevOpenFilesMask;
}
