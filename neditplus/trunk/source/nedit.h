...
typedef struct _UserMenuCache {
    ...
    Boolean      umcMacroMenuCreated; /* indicating, if all macro menu items
                                         were created */
    Boolean      umcFileMenuCreated;
    Boolean      umcEditMenuCreated;
    Boolean      umcSearchMenuCreated;

    UserMenuList umcShellMenuList;    /* list of all shell menu items  */
    UserMenuList umcMacroMenuList;    /* list of all macro menu items  */
    UserMenuList umcFileMenuList;     /* list of all file menu items   */
    UserMenuList umcEditMenuList;     /* list of all edit menu items   */
    UserMenuList umcSearchMenuList;   /* list of all search menu items */
} UserMenuCache;
